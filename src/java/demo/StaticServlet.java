// Modified based on org.mortbay.jetty.handler.ResourceHandler
// The copyright information of the original source codes:
// ========================================================================
 ...
 * Usage: "/static/*" => new StaticServlet("./static")
 * 
 * ! Better let nginx serve static contents instead of jetty in production environment
 * 
 * This handle will serve static content and handle If-Modified-Since headers.
 * No caching is done.
 * Requests that cannot be handled will trigger 404 NOT FOUND.
 * 
...
public class StaticServlet extends HttpServlet {
	...
	public StaticServlet(String base) {
